...
$(document).ready(function(){
	...
	function fetchTemplate(id){
		...
		$.ajax({
		    url : "http://138.197.133.246:80/template/ajax/fetchTemplate",
		    type: "GET",
		    data : formData,
    ...
    function setActive(id){
        var formData = {id:id};
        $.ajax({
            url: "http://138.197.133.246:80/template/ajax/setActive",
            type: "GET",
            data: formData,
            success: function(data){
                fetchTemplate(id);
    ...
    function deleteTemplate(id){
        ...
        $.ajax({
            url: "http://138.197.133.246:80/template/ajax/deleteTemplate",
            type: "GET",
            data: formData,
            success: function(data){
            }
